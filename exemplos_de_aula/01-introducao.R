...
# ordem de precedencia das variáveis 
# character > numeric (double) - numero quebrado
# > numeric (integer)- inteiro > logical
...
sequencia <- c(0, 1, 2, 3, 4, 5)
sequencia_outro_jeito <- 0:5
...
# a função `class()` foi utilizada para encontrar o tipo dos objetos; 
...
# Exemplo 2.5 sort - ordenar um vetor
...
seq(from = c(12,3,12,5,65,1), to = 1)

vetor <- c(1,2, 5, 5,1, 2, 4,5,6)
seq(vetor)
seq(1, length(vetor))
